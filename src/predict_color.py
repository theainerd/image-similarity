...
model.fit_generator(train_generator, epochs = epochs,steps_per_epoch=420,validation_steps = 100S, validation_data=validation_generator,class_weight = class_weight, callbacks=checkpoints)

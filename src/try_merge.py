...
color_attribute = model_color.get_layer('conv2d_55')(color_attribute).name('conv2d_55_xyz')
...
gender_attribute = model_gender.get_layer('conv2d_55')(gender_attribute).name('conv2d_55_abc')
